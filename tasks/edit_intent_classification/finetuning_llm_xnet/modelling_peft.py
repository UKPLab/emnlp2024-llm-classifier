...
class PeftModelForSequenceClassificationCross(PeftModel):
    """
    Peft model for sequence classification tasks with the xnet approach.
...
class AutoModelForSequenceClassificationCross(_BaseAutoModelClass):
    _model_mapping = MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

class AutoPeftModelForSequenceClassificationCross(_BaseAutoPeftModelCross):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.emb_type = args.emb_type
        print('!!!!!!!!AutoPeftModelForSequenceClassificationCross emb_type', self.emb_type)
        print('args: ', args)
    _target_class = AutoModelForSequenceClassificationCross
    _target_peft_class = PeftModelForSequenceClassificationCross
